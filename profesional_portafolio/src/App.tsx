    ...
    <>
          ...
          <div className="max-w-6xl mx-auto flex items-center justify-between">
            <a href="/" className="flex items-center gap-3">
              ...
              <div className="hidden md:block">
                <p className="text-sm text-teal-500">ANDRES ROJO</p>
            ...
            {/* NAV escritorio */}
            <nav className="text-gray-500 hidden md:flex gap-6 text-sm font-medium">
              <a href="#presentacion" className="hover:text-teal-500">
                Presentación
              </a>
              <a href="#formacion" className="hover:text-teal-500">
                Formación
              </a>
              <a href="#proyectos" className="hover:text-teal-500">
                Proyectos
              </a>
              <a href="#contacto" className="hover:text-teal-500">
                Contacto
              </a>
            </nav>
      ...
      {openMenu && (
        ...
        <main className="pt-28">
          ...
          >
            <div>
              <p className="text-teal-500 font-semibold">Hola — soy</p>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {projects.map((p) => (
                ...
                >
                  ...
                  <p className="text-sm text-teal-600 mt-2">{p.tech}</p>
